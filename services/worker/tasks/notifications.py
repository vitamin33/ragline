...
class StreamNotifier:
    ...
    async def add_client_connection(
        self,
        client_id: str,
...
@app.task(
    ...
    name="services.worker.tasks.notifications.start_stream_notifier",
)
...
@app.task(
    bind=True,
    base=NotificationTask,
    name="services.worker.tasks.notifications.add_client_connection",
)
...
@app.task(
    bind=True,
    base=NotificationTask,
    name="services.worker.tasks.notifications.remove_client_connection",
)
...
@app.task(
    bind=True,
    base=NotificationTask,
    name="services.worker.tasks.notifications.get_notifier_stats",
)
