...
async def demo_outbox_pattern():
    ...
    mock_events = [
        OutboxEvent(
            ...
            payload={
                ...
                "currency": "USD",
                "items": [{"product_id": "prod_1", "quantity": 2, "unit_price": 7500}],
        ...
        OutboxEvent(
            ...
            payload={
                ...
                "data": {"order_id": "order_12345", "order_total": "$150.00"},
    ...
    try:
        ...
        for i, event in enumerate(mock_events, 1):
            ...
            # Get stream name
            stream_name = consumer._get_stream_name(
            ...
            print("      ✅ Published to Redis stream")
        ...
        for stream in streams:
            ...
            if length > 0:
                ...
                for msg_id, fields in messages:
                    ...
                    print(
                        f"      📨 {msg_id.decode()}: {event_type} for {aggregate_id}"
                    )
                    if timestamp:
    ...
    try:
        ...
        print(
            f"   📈 Last poll: {time.strftime('%H:%M:%S', time.localtime(metrics['last_poll_time']))}"
        )
