...
from .redis_client import RedisStreamClient, StreamConfig, get_redis_client
...
class StreamProducer:
    ...
    async def publish_event(self, event: StreamEvent) -> str:
        ...
        try:
            ...
            message_id = await client.add_to_stream(
                stream_name=topic.value,
                fields=fields,
                max_len=stream_config.max_len
            )
    ...
    async def publish_order_event(self, order_id: str, event_type: str, 
                                payload: Dict[str, Any], **metadata_kwargs) -> str:
    ...
    async def publish_user_event(self, user_id: str, event_type: str,
                               payload: Dict[str, Any], **metadata_kwargs) -> str:
    ...
    async def publish_product_event(self, product_id: str, event_type: str,
                                  payload: Dict[str, Any], **metadata_kwargs) -> str:
    ...
    async def publish_notification_event(self, notification_id: str, event_type: str,
                                       payload: Dict[str, Any], **metadata_kwargs) -> str:
    ...
    async def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "success_rate": (
                self.events_published / max(1, self.events_published + self.events_failed) * 100
            ),
