...
from .embeddings import EmbeddingManager, SimilarityResult, Document
from .chunking import Chunk, ChunkingStrategy, chunk_menu_item, chunk_policy_document
...
class RAGRetriever:
    ...
    def _format_metadata_for_context(self, metadata: Dict[str, Any]) -> str:
        ...
        relevant_fields = [
            "category", "price", "dietary_info", "rating", 
            "available", "document_type", "section"
        ]
