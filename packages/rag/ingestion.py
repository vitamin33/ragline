...
from .embeddings import EmbeddingManager, Document
from .chunking import ChunkingStrategy, ChunkingConfig, chunk_menu_item, chunk_policy_document
...
SAMPLE_MENU_ITEMS = [
    ...
    },
    {
        ...
        "ingredients": ["quinoa", "roasted vegetables", "chickpeas", "avocado", "tahini"],
        "category": "mains",
        "price": 13.99,
