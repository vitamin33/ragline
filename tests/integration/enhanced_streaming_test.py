...
async def test_enhanced_streaming():
    ...
    try:
        ...
        from streaming import ConversationMemory, StreamBuffer, TokenLimitManager
        ...
        print("   ✅ Buffer created with 1024 byte limit")
        ...
        memory.add_message(
            session_id,
            "assistant",
            "I'd be happy to help you order food! What would you like?",
        )
