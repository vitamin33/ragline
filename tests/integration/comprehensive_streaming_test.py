...
async def comprehensive_streaming_test():
    ...
    try:
        from streaming import (
            StreamBuffer, ConversationMemory, TokenLimitManager, 
            StreamingManager, BufferedEventSourceResponse
        )
        ...
        conversation_data = [
            ...
            ("assistant", "Yes! We have Margherita Pizza ($16.99), Pepperoni Pizza ($18.99), and Vegan Pizza ($15.99)."),
            ("user", "Tell me more about the Margherita"),
            ("assistant", "Our Margherita Pizza features fresh mozzarella, ripe tomatoes, and fresh basil on a thin crust. It's vegetarian-friendly and one of our most popular items."),
            ("user", "Perfect! I'll take one Margherita pizza"),
            ("assistant", "Excellent choice! I'll add one Margherita Pizza ($16.99) to your order."),
            ("user", "What about delivery time?"),
            ("assistant", "Delivery typically takes 30-45 minutes. Would you like to place this order?")
        ]
        ...
        test_scenarios = [
            ...
            {"name": "Medium", "content": "I want to order pizza with extra cheese and pepperoni"},
        ...
        print(f"   ✅ Truncation: {len(long_conversation)} msgs ({original_tokens} tokens) → {len(truncated)} msgs ({truncated_tokens} tokens)")
