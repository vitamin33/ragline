...
async def test_rag_system():
    ...
    if api_key and database_url:
        ...
        try:
            ...
            print(f"   📝 Testing context formatting...")
            ...
            print(f"   ✅ RAG system test completed successfully")
    ...
    try:
        ...
        for i, config in enumerate(retrieval_configs):
            print(f"   ✅ Retrieval config {i+1}: max_results={config.max_results}, threshold={config.similarity_threshold}")
