...
async def demonstrate_rag_system():
    ...
    try:
        from rag.chunking import chunk_menu_item, chunk_policy_document
        from rag.ingestion import SAMPLE_MENU_ITEMS, SAMPLE_POLICY_DOCUMENTS
        ...
        for query in test_queries:
            ...
            for i, (doc, score) in enumerate(results):
                ...
                print(f"     {i+1}. [{doc_type}] {name} (${price}) - {content_preview}...")
        ...
        print(f"✅ Business rules: Dietary preferences, pricing, ratings")
        print(f"✅ Context generation: LLM-ready formatted output")
        print(f"✅ Multi-document types: Menu items, policies, FAQs")
